                ...
                <form action="{{ route('category.update',$category->id) }}" method="POST">
                    ...
                    <div class="row">
                        <div class="mb-3 col-md-6">
                            ...
                            <input type="text" value="{{ $category->category_name }}" name="category_name" class="form-control" id="category_name" placeholder="Enter Category Name">
                            @error('category_name')
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <input type="text" value="{{ $category->icon }}" name="icon" class="form-control" id="icon" placeholder="Category Icon Name">
                            @error('icon')
